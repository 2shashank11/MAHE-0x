        ...
        <div className="w-full p-8">
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            <div className="flex flex-col align-middle md:flex-row">
              <h1 className="text-lg font-semibold mt-4 md:mt-8">Title</h1>
            ...
            <div className="flex flex-col align-middle md:flex-row">
              <h1 className="flex text-lg font-semibold md:mt-4">Journal Name</h1>
            ...
            <div className="flex flex-col align-middle md:flex-row">
              <h1 className="flex text-lg font-semibold md:mt-4">Quartile</h1>
              <Select
            ...
            <div className="flex flex-col align-middle md:flex-row">
              <h1 className="flex text-lg font-semibold md:mt-4">WOS</h1>
              <Select
                label="Yes / No"
                name="wos"
                variant="bordered"
            ...
            <div className="flex flex-col align-middle md:flex-row">
              <h1 className="flex text-lg font-semibold md:mt-4">Authorship</h1>
              <Select
